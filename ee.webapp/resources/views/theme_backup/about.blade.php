...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <section class="ftco-section bg-light">
    	<div class="container">
    		<div class="row d-md-flex">
	    		<div class="col-md-6 ftco-animate img about-image" style="background-image: url('{{asset('theme/images/about.jpg')}}');">
	    		</div>
        ...
        <div class="row">
          <div class="col-md-4 mb-5 ftco-animate">
            <div class="block-10">
              ...
              <img src="theme/images/person_1.jpg" alt="" class="img-fluid mb-3">
          ...
          <div class="col-md-4 mb-5 ftco-animate">
            <div class="block-10">
              ...
              <img src="theme/images/person_3.jpg" alt="" class="img-fluid mb-3">
              <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
            </div>
          </div>
          <div class="col-md-4 mb-5 ftco-animate">
            <div class="block-10">
              ...
              <img src="theme/images/person_2.jpg" alt="" class="img-fluid mb-3">
              <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
            </div>
          </div>
        </div>
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url('{{asset('theme/images/bg_1.jpg')}}');">
    	<div class="container">
    		<div class="row justify-content-center mb-5 pb-5">
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url('{{asset('theme/images/person_1.jpg')}}')">
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url('{{asset('theme/images/person_2.jpg')}}')">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url('{{asset('theme/images/person_3.jpg')}}')">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
