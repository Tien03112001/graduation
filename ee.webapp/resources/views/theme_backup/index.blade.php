    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item cta"><a href="/contact" class="nav-link"><span>Get started</span></a></li>
            </ul>
        </div>
    </div>
</nav>
    ...
    <div class="container-fluid">
        <div class="slider-text d-md-flex align-items-center" data-scrollax-parent="true">
            ...
            <div class="one-forth pr-md-4 ftco-animate align-self-md-center"
                ...
                <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Design. <br>
                    Development. <br> Hosting.</h1>
                <p class="mb-md-5 mb-sm-3" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">A small river
            ...
            <div class="one-half align-self-md-end align-self-sm-center">
                <div class="slider-carousel owl-carousel">
                    <div class="item">
                        <img src="theme/images/dashboard_full_1.png" class="img-fluid img" alt="">
                    </div>
                    <div class="item">
                        <img src="theme/images/dashboard_full_2.png" class="img-fluid img" alt="">
                    </div>
                    <div class="item">
                        <img src="theme/images/dashboard_full_3.png" class="img-fluid img" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 ftco-animate">
                ...
                <p class="domain-price text-center"><span><small>.com</small>9.75</span> <span><small>.net</small>9.90</span>
                    <span><small>.biz</small>$8.95</span> <span><small>.me</small>$7.95</span></p>
            </div>
        </div>
    </div>
</section>
...
<section class="ftco-section ftco-counter img" id="section-counter"
         style="background-image: url({{asset('theme/images/bg_1.jpg')}});">
    <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
            ...
            <div class="col-md-12">
                <div class="carousel-testimony owl-carousel ftco-owl">
                    <div class="item">
                        <div class="testimony-wrap p-4 pb-5">
                            <div class="user-img mb-5"
                                 style="background-image: url('{{asset('theme/images/person_1.jpg')}}')">
                    ...
                    <div class="item">
                        <div class="testimony-wrap p-4 pb-5">
                            <div class="user-img mb-5"
                                 style="background-image: url('{{asset('theme/images/person_2.jpg')}}')">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                            </div>
                    ...
                    <div class="item">
                        <div class="testimony-wrap p-4 pb-5">
                            <div class="user-img mb-5"
                                 style="background-image: url('{{asset('theme/images/person_3.jpg')}}')">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                            </div>
                    ...
                    <div class="tab-pane fade show active" id="v-pills-nextgen" role="tabpanel"
                        ...
                        <div class="d-md-flex">
                            <div class="one-forth align-self-center">
                                <img src="theme/images/dashboard_full_1.jpg" class="img-fluid border" alt="">
                            </div>
                    ...
                    <div class="tab-pane fade" id="v-pills-performance" role="tabpanel"
                        ...
                        <div class="d-md-flex">
                            <div class="one-forth order-last align-self-center">
                                <img src="theme/images/dashboard_full_2.jpg" class="img-fluid border" alt="">
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 ftco-animate">
                <div class="blog-entry" data-aos-delay="100">
                    <a href="blog-single.html" class="block-20"
                       style="background-image: url('{{asset('theme/images/image_2.jpg')}}');">
                    </a>
                    <div class="text p-4">
                        <div class="meta mb-3">
                            <div><a href="#">August 12, 2018</a></div>
            ...
            <div class="col-md-4 ftco-animate">
                <div class="blog-entry" data-aos-delay="200">
                    <a href="blog-single.html" class="block-20"
                       style="background-image: url('{{asset('theme/images/image_3.jpg')}}');">
                    </a>
                    <div class="text p-4">
                        <div class="meta mb-3">
                            <div><a href="#">August 12, 2018</a></div>
                ...
                <div class="ftco-footer-widget mb-4">
                    <div class="block-23 mb-3">
                        <ul>
                            ...
                            <li><span class="icon icon-clock-o"></span><span class="text">Saturday &mdash; Sunday 8:00am - 5:00pm</span>
                            </li>
                        </ul>
                    </div>
