...
class GenerateCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Sinh file tu dong: {type=all,route,controller|repo|allRepo} {model?} {module?}';
    ...
    private function generateAllRepositories()
    {
        $filesInFolder = File::files(app_path('Models'));
        foreach ($filesInFolder as $path) {
            $file = pathinfo($path);
            print_r($file);
            $this->generateRepository($file['filename']);
        }
    }
