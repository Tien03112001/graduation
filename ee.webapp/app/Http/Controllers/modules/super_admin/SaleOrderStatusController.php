...
class SaleOrderStatusController extends RestController
{

    public function __construct(SaleOrderStatusRepositoryInterface $repository)
    {
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!($model instanceof SaleOrderStatus)) {
            return $this->errorNotFound();
        }
    ...
    {
        $model = (new SaleOrderStatus())->find($id);
        if (empty($model)) {
