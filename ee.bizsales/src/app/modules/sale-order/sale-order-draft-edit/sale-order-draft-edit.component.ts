...
@Component({
  selector: 'app-sale-order-draft-edit',
  templateUrl: './sale-order-draft-edit.component.html',
  styleUrls: ['./sale-order-draft-edit.component.css'],
...
export class SaleOrderDraftEditComponent extends AbstractModalComponent<SaleOrderMeta> {
