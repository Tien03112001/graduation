...
@Component({
  selector: 'app-dynamic-table-row-edit',
  templateUrl: './dynamic-table-row-edit.component.html',
  styleUrls: ['./dynamic-table-row-edit.component.css'],
  providers: [DynamicTableRowService]
})
export class DynamicTableRowEditComponent extends AbstractModalComponent<any> {
  ...
  loaded(): void {
    ...
    //   console.log(this.model.cells.row_id)
    // }
